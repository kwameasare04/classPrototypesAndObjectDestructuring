...
Vehicle.prototype.vehicleInfo = function(){
  return `max speed of this vehicle is ${this.maxSpeed} and the weight is ${this.weight}` 
}
 ...
 * VERIFICATION
 */
console.log(smallPlane.vehicleInfo()); // Max speed of the vehicle is 800 and weight is 15

console.log(largePlane.vehicleInfo()); // Max speed of the vehicle is 900 and weight is 40
